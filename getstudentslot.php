...
$studentslotquery = "SELECT SLOTS.SLOTID, SLOTS.SLOTDATE, TIME(SLOTS.SLOTSTART) AS SLOTSTART, TIME(SLOTS.SLOTEND) AS SLOTEND, SLOTS.STUDENTHAWKID, SLOTS.LOCATION, USERTABLE.FIRSTNAME FROM SLOTS, USERTABLE WHERE STUDENTHAWKID=USERTABLE.HAWKID AND STUDENTHAWKID = '$STUDENTHAWKID';";
