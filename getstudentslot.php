...
$studentslotquery = "SELECT SLOTS.SLOTID, SLOTS.SLOTDATE, TIME(SLOTS.SLOTSTART) AS SLOTSTART, TIME(SLOTS.SLOTEND) AS SLOTEND,SLOTS.STUDENTHAWKID, SLOTS.LOCATION FROM SLOTS WHERE STUDENTHAWKID = '$STUDENTHAWKID';";
